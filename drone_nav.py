...
if __name__ == "__main__":
    ...
    # Prompt for model name when saving
    model_name = input("Enter filename to save trained model (default: drone_navigation_balanced.pth): ").strip()
    if not model_name:
        model_name = "drone_navigation_balanced.pth"
